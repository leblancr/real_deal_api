...
config :real_deal_api, RealDealApiWeb.Endpoint,
  ...
  live_view: [signing_salt: "ngpsz8ls"]
...
config :real_deal_api, RealDealApiWeb.Auth.Guardian,
  ...
  secret_key: "KIPda/fDKeBV3N02rduAHeDqN23MREmAxkttVwU97c3RorncCm4a+30LGLofnNRT"
...
config :guardian, Guardian.DB,
  ...
  schema_name: "guardian_tokens", # table?
  sweep_interval: 60 # minutes, remove expired tokens
